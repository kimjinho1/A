export const ErrorMessages = {
  /** Model */
  DATA_SEEDING_NOT_DONE: '데이터 시딩이 안된 상태입니다.',
  CAR_NOT_FOUND: '존재하지 않는 차량 코드입니다.',
  ENGINE_NOT_FOUND: '존재하지 않는 엔진 코드입니다.',
  MISSION_NOT_FOUND: '존재하지 않는 변속기 코드입니다.',
  INVALID_DRIVE_CODE: '잘못된 구동 방식 코드입니다.',
  DRIVE_NOT_FOUND: '존재하지 않는 구동방식 코드입니다.',
  MODEL_NOT_FOUND: '존재하지 않는 차량 모델 코드입니다.',
  NO_MATCHING_TRIM: '필터 정보와 부합하는 트림 정보가 없습니다.',
